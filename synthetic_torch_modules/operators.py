...
The commented out operators are not supported in the pytorch -> inductor code pipeline yet
"""
...
core_operators = linear_operators + convolutions
...
upsampling = ["Upsample", # "UpsamplingNearest2d", 
