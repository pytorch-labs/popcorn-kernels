...
{
    {
        {
            {
                auto tmp0 = c10::div_floor_integer(static_cast<int64_t>(ks0*(c10::div_floor_integer(static_cast<int64_t>(ks1), static_cast<int64_t>(c10::div_floor_integer(static_cast<int64_t>(ks1), static_cast<int64_t>(2L)))))*(c10::div_floor_integer(static_cast<int64_t>(ks2), static_cast<int64_t>(c10::div_floor_integer(static_cast<int64_t>(ks2), static_cast<int64_t>(2L)))))), static_cast<int64_t>(4L));
