...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_fractional_max_pool2d_replication_pad2d_sigmoid_1[grid(triton_poi_fused_fractional_max_pool2d_replication_pad2d_sigmoid_1_xnumel)](buf3, buf1, arg3_1, 32, 32, 588, XBLOCK=256, num_warps=4, num_stages=1)
        del arg3_1
        del buf1
