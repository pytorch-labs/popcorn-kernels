...
# kernel path: /tmp/torchinductor_sahanp/rh/crh6uaniofepf3qwa5tkhda4266linin4s5swbiki2aggpvktzdi.py
...
# kernel path: /tmp/torchinductor_sahanp/fl/cflppgqfh6ud5ytbn4tf6o25cul72a4y5vpj7e6f4h6vaobpcuwy.py
# Topologically Sorted Source Nodes: [x_2], Original ATen: [aten.permute]
# Source node to ATen node mapping:
#   x_2 => permute_1
# Graph fragment:
#   %permute_1 : [num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%squeeze, [0, 2, 1]), kwargs = {})
import triton
import triton.language as tl
