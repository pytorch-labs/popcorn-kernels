...
# kernel path: /tmp/torchinductor_sahanp/a3/ca3yfjptkjryalgbi2djbtodl6skinldemcjpdlrvkrtkbvbhg3w.py
# Topologically Sorted Source Nodes: [x], Original ATen: [aten.silu]
