...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused__log_softmax_3[grid(triton_poi_fused__log_softmax_3_xnumel)](arg2_1, buf1, buf2, buf3, buf4, buf5, 26, 20, 260, XBLOCK=256, num_warps=4, num_stages=1)
        del arg2_1
        del buf1
        del buf2
        del buf3
