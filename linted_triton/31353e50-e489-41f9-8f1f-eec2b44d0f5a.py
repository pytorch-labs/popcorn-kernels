...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        # Topologically Sorted Source Nodes: [multi_head_attention_forward], Original ATen: [aten.clone]
        get_raw_stream(0)
        triton_poi_fused_clone_1[grid(3072)](buf1, primals_2, buf2, 3072, XBLOCK=128, num_warps=4, num_stages=1)
        del primals_2
        ...
        # Topologically Sorted Source Nodes: [multi_head_attention_forward], Original ATen: [aten.view]
        get_raw_stream(0)
        triton_poi_fused_view_3[grid(1024)](buf2, buf4, 1024, XBLOCK=128, num_warps=4, num_stages=1)
        ...
        # Topologically Sorted Source Nodes: [relu, dropout_1], Original ATen: [aten.relu, aten.native_dropout, aten.threshold_backward]
        get_raw_stream(0)
        triton_poi_fused_native_dropout_relu_threshold_backward_6[grid(32768)](buf12, buf20, primals_9, buf22, buf23, buf69, 1, 32768, XBLOCK=256, num_warps=4, num_stages=1)
        del primals_9
        ...
        get_raw_stream(0)
        triton_poi_fused_clone_1[grid(3072)](buf32, primals_14, buf33, 3072, XBLOCK=128, num_warps=4, num_stages=1)
        del buf32
        del primals_14
        ...
        # Topologically Sorted Source Nodes: [multi_head_attention_forward_1], Original ATen: [aten.view]
        get_raw_stream(0)
        triton_poi_fused_view_3[grid(1024)](buf33, buf35, 1024, XBLOCK=128, num_warps=4, num_stages=1)
        ...
        # Topologically Sorted Source Nodes: [relu_1, dropout_4], Original ATen: [aten.relu, aten.native_dropout, aten.threshold_backward]
        get_raw_stream(0)
        triton_poi_fused_native_dropout_relu_threshold_backward_8[grid(32768)](buf12, buf50, primals_21, buf52, buf53, buf66, 4, 32768, XBLOCK=128, num_warps=4, num_stages=1)
        del buf50
        del primals_21
        ...
        # Topologically Sorted Source Nodes: [x_11, x_13], Original ATen: [aten.max_pool2d_with_indices, aten.gelu, aten.gelu_backward]
        get_raw_stream(0)
        triton_poi_fused_gelu_gelu_backward_max_pool2d_with_indices_9[grid(512)](buf61, buf62, buf63, buf64, 512, XBLOCK=128, num_warps=4, num_stages=1)
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    def fn():
        return call([primals_1, primals_2, primals_3, primals_4, primals_5, primals_6, primals_7, primals_8, primals_9, primals_10, primals_11, primals_12, primals_13, primals_14, primals_15, primals_16, primals_17, primals_18, primals_19, primals_20, primals_21, primals_22, primals_23, primals_24, primals_25])
