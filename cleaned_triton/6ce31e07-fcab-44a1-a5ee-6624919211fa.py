...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_abs_avg_pool2d_mul_pow_relu_sign_view_4[grid(triton_poi_fused_abs_avg_pool2d_mul_pow_relu_sign_view_4_xnumel)](buf4, buf5, 19, 19, 32, 32, 1083, XBLOCK=256, num_warps=4, num_stages=1)
        del buf4
