...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        triton_red_fused_linalg_vector_norm_0_r0_numel = s0 + ((-1)*(s0 // 2))
        ...
        triton_red_fused_clamp_min_div_linalg_vector_norm_mul_sum_1_r0_numel = s0 // 2
        stream0 = get_raw_stream(0)
        ...
        # Topologically Sorted Source Nodes: [loss], Original ATen: [aten.exp, aten.mul, aten.sub, aten.mean]
        triton_red_fused_exp_mean_mul_sub_2_r0_numel = 10 + s1
        stream0 = get_raw_stream(0)
