...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        # Topologically Sorted Source Nodes: [x_2], Original ATen: [aten._softmax]
        triton_red_fused__softmax_1_r0_numel = (11 + s0*s1*s2*s3) // 12
        stream0 = get_raw_stream(0)
        ...
        # Topologically Sorted Source Nodes: [x_2], Original ATen: [aten._softmax]
        triton_red_fused__softmax_3_r0_numel = (11 + s0*s1*s2*s3) // 12
        stream0 = get_raw_stream(0)
        ...
        # Topologically Sorted Source Nodes: [x_2, x_3, target, loss], Original ATen: [aten._softmax, aten.view, aten.zeros_like, aten.smooth_l1_loss]
        triton_red_fused__softmax_smooth_l1_loss_view_zeros_like_5_r0_numel = (11 + s0*s1*s2*s3) // 12
        stream0 = get_raw_stream(0)
