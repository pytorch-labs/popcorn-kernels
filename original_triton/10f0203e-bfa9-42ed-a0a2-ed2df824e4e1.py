...
# kernel path: /tmp/torchinductor_sahanp/4h/c4hutzzn3fyewktn5ghub65e6pfsfixdtrucakro23ydehfmnep7.py
# Topologically Sorted Source Nodes: [x_1], Original ATen: [aten.replication_pad2d]
# Source node to ATen node mapping:
#   x_1 => _unsafe_index_4, _unsafe_index_5
# Graph fragment:
#   %_unsafe_index_4 : [num_users=1] = call_function[target=torch.ops.aten._unsafe_index.Tensor](args = (%add_100, [None, None, %clamp_max_4, None]), kwargs = {})
