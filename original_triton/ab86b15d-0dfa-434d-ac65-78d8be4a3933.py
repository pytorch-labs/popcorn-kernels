...
# Source node to ATen node mapping:
#   loss_multi_margin => add_40, clamp_min_5, full_default, gather, iota_5, mean, ne_1, sub_37, where
#   loss_poisson => exp_1, mean_1, mul_47, sub_49
...
#   %ne_1 : [num_users=1] = call_function[target=torch.ops.aten.ne.Tensor](args = (%iota_5, %unsqueeze_1), kwargs = {})
...
#   %where : [num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%ne_1, %clamp_min_5, %full_default), kwargs = {})
...
#   %mul_47 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%abs_1, %relu_1), kwargs = {})
#   %sub_49 : [num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%exp_1, %mul_47), kwargs = {})
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        triton_poi_fused_constant_pad_nd_relu_2[grid(triton_poi_fused_constant_pad_nd_relu_2_xnumel)](buf8, arg3_1, 3, 64, 64, 24504, XBLOCK=256, num_warps=4, num_stages=1)
        del arg3_1
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_randn_like_4[grid(triton_poi_fused_randn_like_4_xnumel)](buf11, buf12, 0, 24504, XBLOCK=256, num_warps=4, num_stages=1)
        del buf11
