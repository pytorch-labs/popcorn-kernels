...
#   add => add_127
#   hinge_loss => add_123, clamp_min_1, full, full_1, mean_1, ne_45, ne_46, sub_37, where, where_1
#   huber_loss => abs_1, lt_65, mean_2, mul_187, mul_188, mul_189, sub_46, sub_47, where_2
...
#   margin_loss => add_66, clamp_min, mean, mul_72, neg, sub_24
...
#   %mul_72 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%neg, %sub_24), kwargs = {})
#   %add_66 : [num_users=1] = call_function[target=torch.ops.aten.add.Scalar](args = (%mul_72, 0.0), kwargs = {})
...
#   %where : [num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%ne_45, %clamp_min_1, %full), kwargs = {})
#   %ne_46 : [num_users=1] = call_function[target=torch.ops.aten.ne.Scalar](args = (%inductor_random_default, -1), kwargs = {})
#   %where_1 : [num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%ne_46, %inductor_random_default_2, %full), kwargs = {})
...
#   %mul_187 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%abs_1, 0.5), kwargs = {})
#   %mul_188 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_187, %abs_1), kwargs = {})
#   %sub_47 : [num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%abs_1, 0.5), kwargs = {})
#   %mul_189 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_47, 1.0), kwargs = {})
#   %where_2 : [num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%lt_65, %mul_188, %mul_189), kwargs = {})
