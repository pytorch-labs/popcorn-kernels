...
# kernel path: /tmp/torchinductor_sahanp/gl/cglq3mmwyfj4soshblrudd35z3ebd5lfpd6pqpin4deeqmtizgfc.py
# Topologically Sorted Source Nodes: [x], Original ATen: [aten.adaptive_max_pool2d]
# Source node to ATen node mapping:
#   x => _low_memory_max_pool2d_with_offsets
# Graph fragment:
#   %_low_memory_max_pool2d_with_offsets : [num_users=1] = call_function[target=torch.ops.prims._low_memory_max_pool2d_with_offsets.default](args = (%arg3_1, [4, 4], [4, 4], [0, 0], [1, 1], False), kwargs = {})
import triton
import triton.language as tl
